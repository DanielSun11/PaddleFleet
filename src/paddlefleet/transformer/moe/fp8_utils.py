...
class ExpertsGroupGemmContiguousNode:
    ...
    def fwd_gate_up_fp8(
        ...
        w1_t_quant, w1_t_scale = fused_stack_quant(expert_w1, transpose=True, use_ue8m0=self.use_ue8m0)
    ...
    def fwd_down_fp8(
        ...
        w2_quant, w2_scale = fused_stack_quant(expert_w2, transpose=True, use_ue8m0=self.use_ue8m0)
    ...
    def bwd_down_input_fp8(
        ...
        bw_w2_quant, bw_w2_scale = fused_stack_quant(expert_w2, transpose=False, use_ue8m0=self.use_ue8m0)
    ...
    def bwd_gate_up_input_fp8(self, do1, expert_w1, dx=None):
        ...
        bw_w1_quant, bw_w1_scale = fused_stack_quant(expert_w1, transpose=False, use_ue8m0=self.use_ue8m0)
    ...
    def fused_transpose_split_quant(
        ...
        if self.use_ue8m0:
            ...
            for tokens in tokens_per_expert:
                out_list.append(paddle.empty([x.shape[1], tokens], dtype="float8_e4m3fn"))
                aligned_mn = _tma_aligned_size(x.shape[1], 4)  # int32 element_size=4
                aligned_k = _ceil_div(tokens, 128 * 4)
                scale_list.append(paddle.empty([aligned_k, aligned_mn], dtype="int32"))
            fuse_transpose_split_fp8_quant(
                x, None, out_list, scale_list, tokens_per_expert, pow_2_scales, True
            )
